...
$H_0$:  There is no difference in the aveage Vitamin C content of cabbages based on cultivation method

$H_A$: There is a difference in the blah blah blah....
...
numerical~catagorical  so we use the Numeical~Cat helper file
